...
const firstLogin = () => {
  loginService
      .login(ACCOUNT_PHONE, ACCOUNT_PASSWORD)
      .then(async response => {
        toastOption.toastSuccess('Đăng nhập thành công')
          ...
          <div class="bg-white relative sm:rounded-lg overflow-hidden">
            <div class="overflow-x-auto">
              <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                  <tr v-for="(ship, index) in paginatedShipRequest" :key="index" class="border-b">
            ...
            <nav
              ...
              <ul class="inline-flex items-stretch">
                <li>
                  <button
                    type="button"
                    class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-gray-500 bg-white rounded-l-lg hover:bg-gray-100 hover:text-gray-700"
                ...
                <li v-for="pageNumber in totalPages" :key="pageNumber">
                  <button
                    ...
                    :class="{
                      ...
                      'text-primary-600 bg-blue-200 hover:bg-primary-100 hover:text-primary-700':
                        pageNumber === currentPage,
                    }"
                ...
                <li>
                  <button
                    type="button"
                    @click="goToNextPage"
                    class="flex items-center justify-center h-full py-1.5 text-gray-500 bg-white hover:bg-gray-100 hover:text-gray-700"
      ...
      <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
        ...
        <div class="flex justify-between items-center mb-2 rounded-t border-b sm:mb-5">
          <h3 class="text-lg font-semibold text-gray-900 flex items-center">
            ...
            <span
              :class="{
                ' border border-gray-500 bg-gray-100 ml-2 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded':
                  selectedShip?.status === 'WAITING_FOR_CONFIRMATION',
                'ml-2 border border-yellow-500 bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded':
                  selectedShip?.status === 'WAITING_FOR_DELIVERY',
                'ml-2 border border-blue-500 bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded':
                  selectedShip?.status === 'ON_DELIVERY',
                'ml-2 border border-green-500 bg-green-100 text-green-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded':
                  selectedShip?.status === 'DELIVERED',
                'ml-2 border border-red-500 bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded':
        ...
        <div class="max-h-[600px] overflow-y-auto mt-2">
          <form>
            <div class="grid mt-2 gap-4 mb-4 sm:grid-cols-2">
              <div>
                <label for="nameProduct" class="block mb-2 text-sm font-medium text-gray-900"
                  >Tên sản phẩm
                </label>
                <input
                  type="text"
              ...
              <div>
                <label for="createBy" class="block mb-2 text-sm font-medium text-gray-900"
                  >Người tạo</label
                >
                <input
                  type="text"
              ...
              <div>
                ...
                <textarea
                  ...
                  class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"></textarea>
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  readonly
                  class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
              </div>

              <div>
                <label for="date" class="block mb-2 text-sm font-medium text-gray-900">Ngày tạo</label>
                <input
                  type="text"
                  name="date"
                  id="date"
                  readonly
                  :value="selectedShip?.createAt ? moment.utc(selectedShip?.createAt).format('DD/MM/YYYY HH:mm:ss') : ''"
                  class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
              </div>
            </div>
            <div>
              ...
              <textarea
                ...
                id="description"
                class="border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"></textarea>
            </div>
            <div class="mt-2">
